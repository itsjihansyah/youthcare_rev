...
<head>
	...
	<!--====== Title ======-->
	<title> Team Member - YouthCare </title>
...
<body>
    ...
    <section class="team-member-area section-gap-extra-bottom">
        <div class="container">
            <div class="row team-members justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        ...
                        <div class="member-info">
                            <h5 class="name"><a href="">Nadia Reva Salsabila</a></h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        ...
                        <div class="member-info">
                            <h5 class="name"><a href="#">Chrisna Maulana F.</a></h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        ...
                        <div class="member-info">
                            <h5 class="name"><a href="#">Jihan Syahira A. P.</a></h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        ...
                        <div class="member-info">
                            <h5 class="name"><a href="#">M. Ibnu Wardhani</a></h5>
				...
				<div class="col-12">
                    <div class="view-more-btn text-center mt-40">
                        <a href="contact.php" class="main-btn">Join Our Team <i class="far fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
